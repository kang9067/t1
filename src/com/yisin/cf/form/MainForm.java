...
public class MainForm extends BasePanel {
	...
	private JComboBox dbFrameCombo;
	private JComboBox cFrameCombo;
	...
	public void initCompant() {
		...
		add(dbFrameLabel);
		dbFrameCombo = new JComboBox(new Object[] { "Mybatis", "Hibernate" });
		...
		add(cFrameLabel);
		cFrameCombo = new JComboBox(new Object[] { "SpringMVC", "Struts2" });
